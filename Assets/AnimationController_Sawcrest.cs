...
public class AnimationController_Sawcrest : AnimationController_BackSprite
{
    ...
    {
        if (data.Equals("sawon"))
        {
            sawActive = true;
        }
        if (data.Equals("sawoff"))
        {
            sawActive = false;
        }
