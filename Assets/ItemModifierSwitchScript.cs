...
public class ItemModifierSwitchScript : MonoBehaviour, ISignalReceiver
{
    ...
    public void SetText()
    {
        ...
        textbox.SetText("Item Modifiers: " + (MainManager.Instance.GetGlobalFlag(MainManager.GlobalFlag.GF_RandomItemModifiers) ? "ON" : "OFF") + "<line>(<button,b> this to toggle)", true);
    }
}
