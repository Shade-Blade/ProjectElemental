...
public class WorldEnemyEntity : WorldEntity, IWorldBattleEntity, IStompTrigger, IDashHopTrigger, ISlashTrigger, ISmashTrigger
{
    ...
    public void DeathDrops()
    {
        ...
        MainManager.Instance.DropCoins(MainManager.Instance.coinDrops, transform.position, Vector3.up * 4.5f, 2f);
        MainManager.Instance.DropItems(MainManager.Instance.dropItemType, MainManager.Instance.dropItemCount, transform.position, Vector3.up * 4.5f - 0.75f * FacingVector(), Vector3.up * 4.5f, 2f);
    }
