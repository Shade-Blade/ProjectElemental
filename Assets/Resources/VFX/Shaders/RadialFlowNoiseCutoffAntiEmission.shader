Shader "VFX/Effect_RadialFlowNoiseCutoffAntiEmission"
{
    Properties
    {
        [HDR]
        ...
        _NoiseCutoffA ("Noise Cutoff A", float) = 0
        _NoiseCutoffB ("Noise Cutoff B", float) = 1
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutput o)
        {
            ...
            if (c.r < _NoiseCutoffA) {
                discard;
            }
            if (c.r > _NoiseCutoffB) {
                discard;
            }
