Shader "Custom/ProperSprite_GrayscalePositionGradientMap" {
	Properties{
		[PerRendererData]_MainTex("Sprite Texture", 2D) = "white" {}
		_Cutoff("Shadow alpha cutoff", Range(0,1)) = 0.5
		_WhiteTopColor("Top White Color", Color) = (0,0,1,1)
		_WhiteBottomColor("Bottom White Color", Color) = (0,0,1,1)
		_BlackTopColor("Top Black Color", Color) = (0,0,1,1)
		_BlackBottomColor("Bottom Black Color", Color) = (0,0,1,1)
	...
	SubShader {
		...
		*/					
		...
		fixed4 _BlackBottomColor;
		fixed4 _WhiteBottomColor;
		fixed4 _BlackTopColor;
		fixed4 _WhiteTopColor;
		...
		*/
		...
		void surf(Input IN, inout SurfaceOutput o) {
			...
			fixed4 realBlack = lerp(_BlackBottomColor,_BlackTopColor,IN.uv_MainTex.y);
			fixed4 realWhite = lerp(_WhiteBottomColor,_WhiteTopColor,IN.uv_MainTex.y);
