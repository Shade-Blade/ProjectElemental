Shader "CameraEffect/VignetteMaskedLeafy" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            half4 fp(v2f i) : SV_Target {
                ...
                half4 maskB = _MaskTex.Sample(point_repeat_sampler, float2(rx + 0.5 + xscr, ry + yscr));
                ...
                output = lerp(col, lerp(_Color, _ColorB, lerpCoeff), clamp(z,1,2) - 1);
