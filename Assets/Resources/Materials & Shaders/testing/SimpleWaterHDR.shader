        ...
        Pass
        {
            ...
            half4 frag (v2f i, UNITY_VPOS_TYPE vpos : VPOS) : SV_Target
            {
                ...
                if (diff < _FoamLength) {
                    ...
                    glowColor = half4(lerp(_Color.rgb, _GlowColor, intersect), intersect);
                }
                ...
                */
                ...
                half4 lightPos = _WorldSpaceLightPos0;
                half3 lightDir = lightPos.xyz;    // Light direction
