Shader "Custom/ProperSprite_Grayscale4PositionGradientMap" {
	Properties{
		[PerRendererData]_MainTex("Sprite Texture", 2D) = "white" {}
		_Cutoff("Shadow alpha cutoff", Range(0,1)) = 0.5
		_WhiteTopLeftColor("Top Left White Color", Color) = (0,0,1,1)
		_WhiteTopRightColor("Top Right White Color", Color) = (0,0,1,1)
		_WhiteBottomLeftColor("Bottom Left White Color", Color) = (0,0,1,1)
		_WhiteBottomRightColor("Bottom Right White Color", Color) = (0,0,1,1)
		_BlackTopLeftColor("Top Left Black Color", Color) = (0,0,1,1)
		_BlackTopRightColor("Top Right Black Color", Color) = (0,0,1,1)
		_BlackBottomLeftColor("Bottom Left Black Color", Color) = (0,0,1,1)
		_BlackBottomRightColor("Bottom Right Black Color", Color) = (0,0,1,1)
	...
	SubShader {
		...
		*/					
		...
		fixed4 _BlackBottomLeftColor;
		fixed4 _WhiteBottomLeftColor;
		fixed4 _BlackTopLeftColor;
		fixed4 _WhiteTopLeftColor;

		fixed4 _BlackBottomRightColor;
		fixed4 _WhiteBottomRightColor;
		fixed4 _BlackTopRightColor;
		fixed4 _WhiteTopRightColor;
		...
		*/
		...
		void surf(Input IN, inout SurfaceOutput o) {
			...
			fixed4 realBlack = lerp(lerp(_BlackBottomLeftColor,_BlackBottomRightColor,IN.uv_MainTex.x),lerp(_BlackTopLeftColor,_BlackTopRightColor,IN.uv_MainTex.x),IN.uv_MainTex.y);
			fixed4 realWhite = lerp(lerp(_WhiteBottomLeftColor,_WhiteBottomRightColor,IN.uv_MainTex.x),lerp(_WhiteTopLeftColor,_WhiteTopRightColor,IN.uv_MainTex.x),IN.uv_MainTex.y);

			fixed4 newcol = lerp(lerp(realBlack,realWhite,RGBToHSV(col.rgb).z), col, _Leak);
			newcol.a = col.a;
