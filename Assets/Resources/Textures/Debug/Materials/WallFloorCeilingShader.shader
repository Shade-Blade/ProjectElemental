Shader "Custom/WallFloorCeilingShader"
{
    Properties
    {
        ...
        _SteepFloorColor ("Steep Floor", Color) = (1,1,1,1)
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            if (IN.worldNormal.y > 0.75) {
                _ShiftColor  = _FloorColor;
            } else if (IN.worldNormal.y > 0.4) {
                _ShiftColor  = _SteepFloorColor;
            } else if (IN.worldNormal.y < -0.75) {
