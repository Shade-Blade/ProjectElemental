Shader "Custom/SkyboxGradient"
{
    Properties
    {
		...
		_SkyColor4("Bottom color",Color) = (0.4, 0.2, 0.1, 0)
        ...
        Pass
		{
			...
			fixed4 frag(v2f i) : COLOR
			{
				...
				if (modified > pointBMod) {
					...
					outColor = lerp(_SkyColor3, _SkyColor2, (modified - pointAMod) / (pointBMod - pointAMod));
				} else {
					outColor = lerp(_SkyColor4, _SkyColor3, (modified) / (pointAMod));
				}
