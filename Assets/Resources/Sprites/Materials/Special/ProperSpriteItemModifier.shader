...
//Note that all item modifiers use the same shader for consistency
//(Setup is that I have black and white images that control the light and dark parts)

Shader "Custom/ProperSpriteItemModifier" {
	Properties{
