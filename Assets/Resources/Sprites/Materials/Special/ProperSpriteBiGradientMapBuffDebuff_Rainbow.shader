...
Shader "Custom/ProperSpriteBiGradientMapBuffDebuff_Rainbow" {
	Properties{
	...
	SubShader {
		...
		*/
		...
		void surf(Input IN, inout SurfaceOutput o) {
			...
			float x = -IN.uv_MainTex.x + IN.uv_MainTex.y;
			c = half4(c.r * color_ramp(_Time.x * 2 + 1 * x) + c.g * half3(1,1,1), c.a);
