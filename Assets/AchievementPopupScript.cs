...
public class AchievementPopupScript : TextDisplayer
{
    public float width;
    ...
    public void Setup(MainManager.Achievement ac)
    {
        string s = GlobalQuestScript.Instance.GetAchievementText(ac, 1);

        SetText("<size,50%>Achievement</size><line>" + s, true, true);
